...
/// </summary>
[DefaultExecutionOrder(0)] // Chỉ định thứ tự thực thi của scripts
public class Target : MonoBehaviour
{
    [Tooltip("Change this color to change the indicators color for this target")]// Hiển thị ra tooltips khi di con trỏ chuột đến giá trị của biến này
